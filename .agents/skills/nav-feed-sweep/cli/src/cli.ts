...
// since/limit are counts: a non-integer, zero, or negative value is a mistake,
// not something to silently coerce. parseInt would accept "-1" and truncate
// "1.5" to 1; Number + Number.isInteger rejects both so the caller hears about
// it instead of getting a quietly wrong result set.
